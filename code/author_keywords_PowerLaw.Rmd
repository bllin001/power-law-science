...
```{r}
# Data Lecture
data <- read.csv("../data/authors_keyword_frequency.csv")
head(data)
...
library(openxlsx) 
write.xlsx(Estimation, "author_keywords_Estimation.xls", 
           sheetName = "results", rowNames = FALSE)
write.csv(Estimation,file="author_keywords_Estimation.csv") 
