...
```{r}
library(openxlsx) 
write.xlsx(df.word_count, "T0_word_count.xls", 
           sheetName = "hoja_de_trabajo", rowNames = FALSE)
write.csv(df.word_count,file="T0_word_count.csv") 
...
library(openxlsx) 
write.xlsx(Estimation, "T0_Estimation.xls", 
           sheetName = "hoja_de_trabajo", rowNames = FALSE)
write.csv(Estimation,file="T0_Estimation.csv") 
